...
const RightSidebar = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen px-5 mt-20 items-center hidden md:flex">
        <h1 className="text-black text-lg font-semibold">Coming soon.</h1>
        <span className="text-sm text-gray-600">untill enjoy the voices and letters.</span>
        <Link href="/write" className="text-brand mt-3" >express yourself :)</Link>
    </div>
